...
auto english_catalog() -> MessageCatalog {
    return {
        ...
        {"workspace.command_instructions", "Enter Execute   Esc Cancel   Type help for commands"},
        ...
        {"workspace.home_shortcuts", "Ctrl+O Open database   Ctrl+N Create database   Ctrl+P Command   F10 Menu"},
        {"workspace.help_shortcuts",
         "F10 menu  Alt+F File  Ctrl+O open  Ctrl+N create  Ctrl+P command  Ctrl+Tab next tab  Ctrl+W close tab"},
